        ...
        <div class="card-body">
            <form action="khach_hang_kt_code.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <tr>
                                        <th>
                                            <?php
                                                ...
                                                {
                                                    echo '
                                            <input type="checkbox" name="id_lop[]" value="'.$row['id_lop'].'"></input>
                                                    ';
                                                }
                                                else{
                                        ...
                                        <td>
                                            <?php
                                            if ($row['thanhtoan'] == 1) {
                                                echo("<input type='hidden' name='check-thanhtoan[]' value='1'>");
                                                echo '✔';
                                            } else {
                                                echo("<input type='hidden' name='check-thanhtoan[]' value='0'>");
                                                echo '❌';
                                            }
                                            ?></td>
                                        <td>
                                            <input type="text" name="hocphi[]" value="<?php echo($row['hocphi'])?>" readonly>
                                        </td>
                ...
                <div class="card-body">
                    ...
                    <span>
                        <button type="submit" name="thanhtoan_vnpay" class="btn btn-danger" style="float: right;"> Thanh Toán Qua VNPay </button>
                    </span>
                </div>
        </div>
